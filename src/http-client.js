...
export default (opts) => {
  ...
  return {
    ...
    withdrawHistory: (payload) =>
      privCall("/wapi/v3/withdrawHistory.html", payload),
    depositHistory: (payload) =>
      privCall("/wapi/v3/depositHistory.html", payload),
    depositAddress: (payload) =>
      privCall("/wapi/v3/depositAddress.html", payload),
    ...
    marginGetDataStream: () =>
      privCall("/sapi/v1/userDataStream", null, "POST", true),
    ...
    futuresGetDataStream: () =>
      privCall("/fapi/v1/listenKey", null, "POST", true),
    ...
    marginAllOrders: (payload) =>
      privCall("/sapi/v1/margin/allOrders", payload),
    marginOrder: (payload) => order(privCall, payload, "/sapi/v1/margin/order"),
    marginCancelOrder: (payload) =>
      privCall("/sapi/v1/margin/order", payload, "DELETE"),
    marginOpenOrders: (payload) =>
      privCall("/sapi/v1/margin/openOrders", payload),
    marginAccountInfo: (payload) =>
      privCall("/sapi/v1/margin/account", payload),
    marginMyTrades: (payload) => privCall("/sapi/v1/margin/myTrades", payload),
    marginRepay: (payload) =>
      privCall("/sapi/v1/margin/repay", payload, "POST"),
    marginLoan: (payload) => privCall("/sapi/v1/margin/loan", payload, "POST"),
    marginIsolatedAccount: (payload) =>
      privCall("/sapi/v1/margin/isolated/account", payload),
    marginMaxBorrow: (payload) =>
    ...
    futuresAggTrades: (payload) =>
      aggTrades(pubCall, payload, "/fapi/v1/aggTrades"),
    futuresMarkPrice: (payload) => pubCall("/fapi/v1/premiumIndex", payload),
    futuresAllForceOrders: (payload) =>
      pubCall("/fapi/v1/allForceOrders", payload),
    ...
    futuresCancelOrders: (payload) =>
      privCall("/fapi/v1/batchOrders", payload, "DELETE"),
    futuresCancelAllOrders: (payload) =>
    ...
    futuresPositionRisk: (payload) =>
      privCall("/fapi/v2/positionRisk", payload),
